				...
				<nav class="navbar navbar-inverse">
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<ul class="sidebar-menu">
							<li class="header" align="center">MENU DE NAVEGAÇÃO</li>
							...
							<li class="treeview <?php echo $esc_todos?>">
								...
								<ul class="treeview-menu">								
									...
									<li class=""><a href="index.php?pagina=logados"><i class="fa fa-angle-right"></i> Logados</a></li>
							...
							<li class="treeview <?php echo $esc_usr?>">
								<a href="#" align-items-center>
					...
					<div class="header-left">
						...
						<div class="profile_details_left"><!--notifications of menu start -->
							<ul class="nofitications-dropdown">
								...
								$res2 = $query2->fetchAll(PDO::FETCH_ASSOC);
								$liberacao_func_sistema = @count($res2);

								$query = $pdo->query("SELECT * FROM funcionarios where ativo = 'Não' order by nome asc limit 6 ");
								$res = $query->fetchAll(PDO::FETCH_ASSOC);
								$liberacao_func_sistema_limit = @count($res);
								 ?>
								<li class="dropdown head-dpdn ">
									<a href="#" class="dropdown-toggle <?php echo $esc_todos ?>" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-street-view"></i>
										
										<span class="badge blue3"><?php echo $liberacao_func_sistema ?></span></a>
									<ul class="dropdown-menu">
										<li>
											<div class="notification_header">
												<h3>Existem <?php echo $liberacao_func_sistema ?> Funcionários Bloqueados!</h3>
											</div>
										</li>

										<?php 
											if($liberacao_func_sistema_limit > 0){
											for($i=0; $i < $liberacao_func_sistema_limit; $i++){
												foreach ($res[$i] as $key => $value){}
											$id_tec = $res[$i]['id'];
											$nome_tec = $res[$i]['nome'];											
										...
										<li>
											<a href="#">
											<div class="notification_desc">
												<p><i class="fa fa-expeditedssl text-danger" style="margin-right: 3px"></i><?php echo $nome_tec ?></p>
												<p><span><?php echo $telefone ?></span></p>
											</div>
											<div class="clearfix"></div>	
											</a>
											<hr style="margin:2px">
		...
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title" id="exampleModalLabel">Relatório de Atendimento
					<small>(
							<a href="#" onclick="datas('1971-01-01', 'tudo-Atend', 'Atend')">
								<span style="color:#000" id="tudo-Atend">Tudo</span>
							</a> /
							<a href="#" onclick="datas('<?php echo $data_atual ?>', 'hoje-Atend', 'Atend')">
								<span id="hoje-Atend">Hoje</span>
							</a> /
							<a href="#" onclick="datas('<?php echo $data_mes ?>', 'mes-Atend', 'Atend')">
								<span style="color:#000" id="mes-Atend">Mês</span>
							</a> /
							<a href="#" onclick="datas('<?php echo $data_ano ?>', 'ano-Atend', 'Atend')">
								<span style="color:#000" id="ano-Atend">Ano</span>
							</a> 
							)</small>
			...
			<form method="post" action="rel/atendimentohome_class.php" target="_blank">
			<div class="modal-body">
				...
				<div class="row">
					<div class="col-md-4">						
						<div class="form-group"> 
							...
							<input type="date" class="form-control" name="dataInicial" id="dataInicialRel-Atend" value="<?php echo date('Y-m-d') ?>" required> 
						</div>						
					</div>
					<div class="col-md-4">
						<div class="form-group"> 
							<label>Chamado <small>(Final)</small></label> 
							<input type="date" class="form-control" name="dataFinal" id="dataFinalRel-Atend" value="<?php echo date('Y-m-d') ?>" required> 
						</div>
					</div>
				...
				<div class="row">
					<div class="col-md-4">						
						<div class="form-group"> 
							...
							<select class="form-control sel3index" name="tipo_chamado" id="tipo_chamado" style="width:100%;">
					...
					<div class="col-md-4">						
						<div class="form-group"> 
							<label>Técnico</label> 
							<select class="form-control sel3index" name="tecnico" id="tecnico" style="width:100%;">
								<option value="">Selecione</option>
					...
					<div class="col-md-4">						
						<div class="form-group"> 
							...
							<select class="form-control sel3index" name="reparticao" id="reparticao" style="width:100%;">
								<option value="">Selecione</option>
